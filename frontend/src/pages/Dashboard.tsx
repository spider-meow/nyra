      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            {admin ? <LinkButton to={link("lectures")} variant="primary">Relire le site</LinkButton> : null}
          </>
        }
      />
      ...
      <section className="grid gap-8 rounded-[20px] border border-line bg-paper p-6 md:p-8 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
        ...
        {lastCrawl ? (
          <div className="rounded-2xl bg-sunk p-5">
            ...
            <p className="mt-1 truncate font-mono text-[13px]" title={lastCrawl.site_url}>{hostOf(lastCrawl.site_url)}</p>
